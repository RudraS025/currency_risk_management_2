...
const interestRateSources = [
  { name: 'RBI Repo Rate', rate: 5.50, country: 'India', currency: 'INR' },
  ...
  if (!isMounted) {
    return (
      <div className="space-y-6">
        {/* Header with Static Loading State */}
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              disabled
              className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-gray-400 cursor-not-allowed text-white"
            >
